...
if __name__ == '__main__':
    ...
    # 创建两个线程
#     try:
#         _thread.start_new_thread( get_esnews )
#         # _thread.start_new_thread( get_esnews_2 )
#         # _thread.start_new_thread( get_market_news, () )
#         # _thread.start_new_thread( get_market_news, (["38"]) )
#         # _thread.start_new_thread( get_market_news, (["39"]) )
#     except:
